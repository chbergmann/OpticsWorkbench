...
__doc__ = translate('Sun Ray', 'Declare your FreeCAD objects to be optical mirrors, lenses or absorbers')
...
class SunRayWorker:
    def __init__(self, 
        ...
        fp.addProperty('App::PropertyLinkList',  'Rays',   'SunRay', 
                        translate('Sun Ray', 'Create rays of different wavelength')).Rays = rays   
        fp.Proxy = self
        self.update = True
...
class RaySun():
    ...
    def GetResources(self):
        ...
        return {'Pixmap'  : os.path.join(_icondir_, 'raysun.svg'),
                ...
                'MenuText': QT_TRANSLATE_NOOP('Sun Ray', 'Ray (sun light)'),
                'ToolTip' : QT_TRANSLATE_NOOP('Sun Ray', 'Declare your FreeCAD objects to be optical mirrors') }
