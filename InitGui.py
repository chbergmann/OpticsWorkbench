...
class OpticsWorkbench (Workbench):
    ...
    def Initialize(self):
        ...
        import Plot
        from examples import example1, example3D, example_dispersion, example_candle, example_semi, example_hierarchy3D, example_energy
        ...
        examples = [QT_TRANSLATE_NOOP('Workbench', 'Example2D'), 
            ...
            QT_TRANSLATE_NOOP('Workbench', 'ExampleEnergyDensity')]
